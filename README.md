...
### See if it is possible to find the local Chrome installation (if any) with Puppeteer

download the OPML file through the user's browser profile (to avoid having them sign in)

- https://github.com/GoogleChrome/puppeteer/issues/4394
